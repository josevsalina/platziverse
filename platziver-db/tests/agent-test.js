...
test.serial('Setup', t => {
  ...
  t.true(AgentStub.hasMany.calledWith(MetricStub), 'Argument should be a mod be the MetricStubmodel')
  t.true(MetricStub.belongsTo.called, 'MetricModel.belongsTo was executed')
  t.true(MetricStub.belongsTo.calledWith(AgentStub), 'Argument should be a mod be the AgentStubmodel')
})
...
test.afterEach(() => {
  if (sandbox) sandbox = sandbox.restore()
})
